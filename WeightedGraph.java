...
public class WeightedGraph {
	...
	public static void main(String args[]) {
		...
		*/
		...
		final WeightedGraph y = new WeightedGraph(8);
		// Create a graph t
		y.setLabel(0, "v0");
		y.setLabel(1, "v1");
		y.setLabel(2, "v2");
		...
		//Test the Dijkstra's algorithm to find the shortest path from v0 to every other node in graph y
		int[] pred2 = Dijkstra.dijkstra(y, 0);
		for (int n = 0; n < 8; n++) {
			Dijkstra.printPath(y, pred2, 0, n);
		}
		//Expected output
		/*
		[v0]
